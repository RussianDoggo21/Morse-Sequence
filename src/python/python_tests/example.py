...
morse_seq_inc, n_crit_inc = ms.increasing(st) # Computation of an increasing Morse Sequence on st and its critical simplices
...
# To run the file from the root : python3 -m src.python.python_tests.example